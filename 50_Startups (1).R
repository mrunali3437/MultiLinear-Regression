...
startup <- read.csv("C:/Users/abc/Desktop/Data science/Dataset/Multi Linear Regression/50_Startups.csv")
attach(startup)
...
ggplot(startup) + geom_histogram(aes(Administration),binwidth = 6000 ,fill = "black") + xlab("Administration")
